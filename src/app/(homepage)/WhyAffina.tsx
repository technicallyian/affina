...
export default function WhyAffina() {
  return (
    <Section className="bg-primary-dark p-40 pb-[800px]">
      <div className="max-w-5xl mx-auto relative flex justify-center items-center">
        <StarBackgroundIcon className="absolute z-0" />
        <div className="relative z-10">
          <Heading as="h2" level={1} className="text-white text-center">Why <span className="text-primary">affina</span></Heading>
        </div>
      </div>
    </Section>
  );
